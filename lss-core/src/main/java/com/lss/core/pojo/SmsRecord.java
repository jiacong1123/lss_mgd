...
public class SmsRecord {
    ...
    /** 记录类型记录类型 OUTBOUND, 外发短信；OUTBOUND_UNKNOWN, 陌生外发短信；INBOUND, 客户回复短信；INBOUND_CHANNEL, 渠道短信；INBOUND_UNKNOWN, 陌生短信*/
    private String type;
    ...
    /** 短信状态 SENT, 成功发送 ；INVALID_SHOW_NUMBER, 显示号码不合法；INVALID_RECEIVER_NUMBER, 接收号码非手机号；OTHER, 其他失败*/
